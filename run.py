...
def _main(qTable) :
    ...
    envV = FrameEnv(videoName=videoName, videoPath=videoPath, resultPath=resultPath, isDetectionexist=False, isClusterexist=True, isRun=True, outVideoPath=outVideoPath)   # etc
